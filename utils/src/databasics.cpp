	...
	MPI_Comm comm)
{
	...
	MPI_Bcast(&use_mask,1,MPI_UINT64_T,0,comm);
	MPI_Bcast(&use_modulus,1,MPI_UINT64_T,0,comm);
	...
	MPI_Gather(&result,1,MPI_UINT64_T,
				tmp,1,MPI_UINT64_T,
				0,comm);
	...
	MPI_Bcast(&result,1,MPI_UINT64_T,0,comm);
